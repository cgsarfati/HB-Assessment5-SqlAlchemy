...
class Brand(db.Model):
    ...
    brand_id = db.Column(db.String(10), autoincrement=True, primary_key=True)
...
class Model(db.Model):
    ...
    brand_id = db.Column(db.String(20), db.ForeignKey('brands.brand_id'))
    ...
    brand = db.relationship("Brand", backref=db.backref("models", order_by=brand_id))
